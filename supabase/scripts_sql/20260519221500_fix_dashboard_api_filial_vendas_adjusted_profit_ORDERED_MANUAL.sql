-- ============================================================================
-- Dashboard 360: ajuste da fonte alternativa /filial/vendas
-- ============================================================================
--
-- Uso manual no Supabase SQL Editor:
-- 1. Execute os blocos abaixo de cima para baixo.
-- 2. Se for selecionar manualmente, selecione o bloco completo entre
--    "INICIO BLOCO" e "FIM BLOCO".
-- 3. Nao execute trechos internos de CASE/WHEN/THEN isoladamente.
--
-- Mapeamento aplicado:
...
-- ============================================================================
-- INICIO BLOCO 02/08 - Indicadores MTD
-- ============================================================================
...
-- ============================================================================
-- INICIO BLOCO 03/08 - Indicadores YTD
-- ============================================================================
...
-- ============================================================================
-- INICIO BLOCO 04/08 - Grafico de vendas por mes
-- ============================================================================
...
-- ============================================================================
-- INICIO BLOCO 05/08 - Grafico de lucro por mes
-- ============================================================================
...
-- ============================================================================
-- INICIO BLOCO 06/08 - Listagem por filial
-- ============================================================================
--
-- Este bloco precisa manter o DROP antes do CREATE porque o retorno de
-- total_sku/pa_total_sku/delta_sku passa a ser numeric.
...
-- ============================================================================
-- INICIO BLOCO 07/08 - Comentarios das funcoes
-- ============================================================================
...
-- ============================================================================
-- INICIO BLOCO 08/08 - Validacao do caso Lucia / Filial 1 / 18-05-2026
-- ============================================================================
--
-- Resultado esperado para o card:
-- total_vendas = 22746.44
-- total_lucro = 6275.19
-- ticket_medio ~= 49.34
-- margem_lucro ~= 27.5876
...
select
  ...
  ticket_medio,
  margem_lucro
from public.get_dashboard_data_api_filial_vendas(
  'lucia',
  '2026-05-18'::date,
  '2026-05-18'::date,
  array['1']::text[]
...
-- Resultado esperado para a listagem:
-- valor_total = 22746.44
-- custo_total = 16471.25
-- total_lucro = 6275.19
-- ticket_medio ~= 49.34
-- margem_lucro ~= 27.59
-- total_cupons = 461
...
select
  ...
  total_cupons,
  total_sku
from public.get_vendas_por_filial_api_filial_vendas(
  'lucia',
  '2026-05-18'::date,
  '2026-05-18'::date,
  '1',
